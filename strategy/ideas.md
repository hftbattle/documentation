...
Выше для наглядности мы нарисовали собственный график - график величины $$(best\_ask + best\_bid) / 2 - 208000$$, (такая нормировка сделана, чтобы цена и текущий результат были примерно в одном диапазоне значений):
