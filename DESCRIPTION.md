# Основные особенности {{ book["contest.name"] }}
...
- Обратите внимание, что основной стакан – это реальный стакан, то есть список заявок и сделок, реально происходивших на бирже. На него вы влиять не могли.
