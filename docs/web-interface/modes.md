...
В рейтинговом режиме ваша стратегия будет запущена на фиксированном заранее определенном наборе дней, которых нет среди тренировочных дней и который не будет меняться в течение всего контеста. Этот режим служит двум целям:
