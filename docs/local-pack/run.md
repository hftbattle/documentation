...
Для этого достаточно зайти в *Run > Edit configurations*, там задать в качестве *Executable* исполняемый файл, соответствующий вашей платформе. Например, для Mac OS X фа  йл называется *mac_launcher* и лежит в корне репозитория.
