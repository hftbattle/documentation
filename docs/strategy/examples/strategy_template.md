...
Для стратегий, торгующих на одном инструменте и получающих обновления от некоторого другого инструмента (называемого сигнальным) понадобятся следующие функции:
```cpp
