...
Для проверки своих идей вам предоставляется три набора торговых дней: **тренировочный**, **контрольный** и **еженедельный**. Через месяц после окончания основного этапа соревнования будет проведено тестирование на **финальном** наборе данных.
