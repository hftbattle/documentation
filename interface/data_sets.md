...
Вы можете совершать посылки в систему в двух режимах: **тренировочном** и **контрольном**. Кроме того, в начале каждой календарной недели будет проводиться **еженедельное** тестирование трех ваших стратегий на новых данных. При этом вы можете сами выбрать, какие это будут стратегии, пометив их звездочкой в таблице посылок. Если вы не пометите ни одной стратегии илли пометите меньше трех, то система автоматически довыберет за вас, полагаясь на результаты ваших стратегий на контрольной выборке.
