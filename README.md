...
- Начните разработку локально, у себя на машине. Для этого можно [скачать]() настроенный образ VirtualBox    Скачайте пакет для локальной разработки на С++. Пакет опубликован на [GitHub](https://github.com/hftbattle/hftbattle).
