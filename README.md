...
- Скачать [Local Pack]({{ book["contest.local-pack.url"] }}) для разработки у себя на машине. Как им пользоваться описано в разделе [Local Pack](./docs/local-pack/README.md), а также в файле README в репозитории.
