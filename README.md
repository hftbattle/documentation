...
- Скачать [Local Pack]("./local-pack/README.md) для локальной разработки на вашей машине: [{{ book["contest.local-pack.name"] }}]({{ book["contest.local-pack.url"] }}). Как пользоваться локал паком описано в находящемся там же файле README.txt.
