...
Также вы можете выбирать, на каких днях запускать стратегию.
...
- контрольные посылки выполняются на определенном наборе дней ({{ book["data.control_days"] }} дней), которые недоступны в тренировочном режиме
- вам доступна минимальная информация о поведении вашей стратегии на рейтинговых днях
