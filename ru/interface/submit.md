...
Посылки с большим числом комбинаций параметров могут работать значительно дольше, чем посылки без перебора параметров, так как они получают уменьшенный приоритет по сравнению с посылками без перебора параметров.
