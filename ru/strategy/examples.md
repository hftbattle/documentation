...
#####Модифицируем предыдущую стратегию.<a id="stay_on_best_price_improved"></a>
...
Согласно правилам, [позиция](/terms.md#position) не может быть превышать 50, подробнее см. [Ограничения симулятора](/simulator.md#restrictions).
...
#####Модифицируем предыдущую стратегию.<a id="deals_count_diff_limited"></a>
