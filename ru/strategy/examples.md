...
2. Мы не будем ставить заявку, если от противоположной лучшей цены она отстоит меньше, чем на заранее заданное значение. (Это имеет смысл поменять, если окажется, что из-за этого условия мы часто вообще не стоим на данном направлении. В таком случае можно, например, двигать цену вглубь стакана, пока мы не отойдем от противоположной лучшей на `offset_`).
...
5. Выше уже отмечалось, что просто `middle_price` может плохо отражать справедливую цену в случае разреженного стакана. Стоит подумать над тем, как правильнее ее оценивать - как пример, можно не учитывать маленьике объемы на ценовых уровнях.
