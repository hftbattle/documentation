...
- Попробуйте увеличить значение отрицательного результата, при котором стратегия заканчивает торговлю.
- Попробуйте ставить больше, чем 1 заявку на цену (или заявки с б&oacute;льшим объёмом).
- Если значительное число заявок было снято с лучшей цены, то, воможно, цена дальше пойдёт в этом направлении.
- Ставьте заявки не только на лучшую цену.
