...
Здесь также есть три функции, которые вы можете реализовать, а также функция *init*, которая позволяет получать информацию из файла конфигурации или из веб-интерфейса.
...
Она принимает на вход ссылку на [OrderBook](/api/OrderBook.md), который является обновлённой версией торгового стакана.
...
Заметьте, что по каждой совершённой сделке информация о ней приходит **ровно один раз**.
