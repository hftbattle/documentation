...
| [volume_by_price()](#volume_by_price) | Суммарный объём лотов по всем заявкам с данным направлением и ценой. |
| [best_price()](#best_price) | Лучшая цена в стакане по данному направлению. |
| [best_volume()](#best_volume) | Суммарный объём лотов по всем заявкам с лучшей ценой и направлением. |
...
| [added_volume_at_price()](#added_volume_at_price) | Суммарный объём новых добавленных заявок по данному направлению и цене. |
...
Возвращает суммарный объём лотов по всем заявкам по направлению dir с ценой price.
...
Возвращает суммарный объём лотов по всем заявкам на лучшей цене по направлению dir.
