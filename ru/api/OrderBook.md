...
То есть котировка с порядковым номером 3 не обязательно отстоит ровно на 3 минимальных шага цены от котировки с лучшей ценой.
...
| [all_quotes()](#all_quotes) | Все котировки с данным направлением в виде QuotesHolder. |
